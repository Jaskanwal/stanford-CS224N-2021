...
if args.function == 'pretrain':
    ...
    #     num_workers=4
    tconf = trainer.TrainerConfig(max_epochs=650, batch_size=128, learning_rate=6e-4,
    ...
    # Make the finetune_dataset dataset
    finetune_dataset = dataset.NameDataset(pretrain_dataset, open(args.finetune_corpus_path, 'r').read())
